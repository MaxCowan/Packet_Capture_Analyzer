    ...
    <body>
        ...
        <div style="align-content: center; text-align: center;">
            ...
            <div class="container" style="margin-bottom: 30px;">
                <div class="btn-group">
                    <button type="button" class="btn btn-primary" disabled="disabled">All Time</button>
                    <a class="btn btn-primary" href="recent.jsp" role="button">Most Recent 30 Minutes</a>
                </div>
            </div>
        ...
        <%
            ...
            try {
                senderChart= new FusionCharts(
                        ...
                        "json",// dataFormat
                        queryHelp.generateChartJSON("popSender", "all") //dataSource
                );
            }
        ...
        <%
            ...
            try {
                destPortChart= new FusionCharts(
                        ...
                        "json",// dataFormat
                        queryHelp.generateChartJSON("popDestPort", "all") //dataSource
                );
            }
            catch(SQLException e){
                out.print(e.getStackTrace());
        ...
        <%
            ...
            try {
                netActivityChart= new FusionCharts(
                        ...
                        "json",// dataFormat
                        queryHelp.generateChartJSON("netActivity", "all") //dataSource
                );
            }
            catch(SQLException e){
                out.print(e.getStackTrace());
        ...
        <%
            ...
            try {
                frameLenChart= new FusionCharts(
                        ...
                        "json",// dataFormat
                        queryHelp.generateChartJSON("frameLen", "all") //dataSource
                );
            }
            catch(SQLException e){
                out.print(e.getStackTrace());
